  ...
  return (
    <section id="home" className=''>
        <div className='h-48 relative flex justify-around item-center' style={heroImageStyle}>
            ...
            <p className='text-lg text-slate-900/80' >Department of Mathematics and Applications, University Ibn Tofail - Department of Mathematics and Computer Science, University of Calabria </p>
            <p className='text-lg text-slate-900/80' >Kénitra, Morocco</p>
            <p className='text-lg text-slate-900/80' >Rende, Italy</p>
            <p className='text-lg text-slate-900/80 ' >Phone: +212 616968137</p>
